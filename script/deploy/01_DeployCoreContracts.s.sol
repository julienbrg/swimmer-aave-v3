...
contract DeployCoreContracts is BaseScript {
    ...
    function _deployCoreContracts(DeploymentParams memory params) 
        internal 
        returns (CoreContracts memory contracts) 
    {
        ...
        contracts.poolAddressesProvider = address(
            new PoolAddressesProvider(params.marketId, params.owner)
        );
        ...
        contracts.poolAddressesProviderRegistry = address(
            new PoolAddressesProviderRegistry(params.owner)
        );
        ...
        PoolAddressesProviderRegistry(contracts.poolAddressesProviderRegistry)
            .registerAddressesProvider(contracts.poolAddressesProvider, 1);
        console.log("   PoolAddressesProvider registered in registry");
        
        // 3. Deploy ACLManager
        console.log("\n3. Deploying ACLManager...");
        contracts.aclManager = address(
            new ACLManager(IPoolAddressesProvider(contracts.poolAddressesProvider))
        );
        ...
        PoolAddressesProvider(contracts.poolAddressesProvider)
            .setACLManager(contracts.aclManager);
        console.log("   ACLManager set in PoolAddressesProvider");
        
        // 4. Deploy Pool implementation
        console.log("\n4. Deploying Pool implementation...");
        contracts.pool = address(
            new Pool(IPoolAddressesProvider(contracts.poolAddressesProvider))
        );
        console.log("   Pool implementation deployed:", contracts.pool);
        
        // 5. Deploy PoolConfigurator implementation
        console.log("\n5. Deploying PoolConfigurator implementation...");
        contracts.poolConfigurator = address(
            new PoolConfigurator()
        );
        console.log("   PoolConfigurator implementation deployed:", contracts.poolConfigurator);
        
        // 6. Deploy AaveOracle
        console.log("\n6. Deploying AaveOracle...");
        contracts.oracle = address(new AaveOracle(
        ...
        // 7. Deploy AaveProtocolDataProvider
        console.log("\n7. Deploying AaveProtocolDataProvider...");
        contracts.protocolDataProvider = address(
            new AaveProtocolDataProvider(IPoolAddressesProvider(contracts.poolAddressesProvider))
        );
        console.log("   AaveProtocolDataProvider deployed:", contracts.protocolDataProvider);
        
        // 8. Set implementations in PoolAddressesProvider
        console.log("\n8. Setting implementations in PoolAddressesProvider...");
        ...
        // 9. Setup initial admin roles
        console.log("\n9. Setting up initial admin roles...");
